...
uses
  Classes,windows,sysutils,{CmtVerNfo,}umediar,
 ares_types,ComObj,Activex,const_ares,
 classes2,graphics,{comettrees,tntwindows,}class_cmdlist,
 helper_share_misc,DirectDraw,Directshow9,uExtraData{, Dspack};
...
try
    ...
    EnterCriticalSection(ServiceSection);
      try
        {synchronize}(sharedlist_GetGlobal);  //<---clear library from frmmain
      finally
...
//      categs_compute;
       ...
       try
         ...
         LeaveCriticalSection(ServiceSection);
              ...
              // put previewable DB_TOWRITE to formmain
