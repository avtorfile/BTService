...
uses
classes,graphics,windows,sysutils,const_ares,
//CmtVerNfo,const_win_messages,DSPack,comettrees,tntwindows,
ShlObj,ares_objects,btcore,controls;
...
uses
 {ufrmmain,}vars_global,vars_localiz,forms;
