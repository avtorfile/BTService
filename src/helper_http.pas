...
winsock, sysutils, helper_strings,const_ares;
...
//DIMPGTOK
result:=chr(68)+chr(73)+chr(77)+chr(80)+chr(71)+chr(84)+chr(79)+chr(75);
end;
...
//DIMPGT
result:=chr(68)+chr(73)+chr(77)+chr(80)+chr(71)+chr(84);
end;
...
begin
//Server: Ares
//Server: Data Interchange Manager
result:=chr(83)+chr(101)+chr(114)+chr(118)+chr(101)+chr(114)+chr(58)+chr(32)+AGENT_NAME+chr(32);
...
lung:integer;
 ...
 lista:tmystringlist;
               ...
               begin
                ...
                vars_global.LANIPc:=inet_addr({pchar}PAnsiChar(vars_global.LANIPs));
