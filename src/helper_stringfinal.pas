...
//procedure finalize_user_channel(Sender: TBaseCometTree;Node: PCmtVNode);
...
//procedure finalize_search_result_chat(Sender: TBaseCometTree;Node: PCmtVNode);
...
begin
 data:=sender.getdata(node);
  ...
  if data^.avatar<>nil then data^.avatar.free;
end;
