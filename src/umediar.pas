...
uses
 Classes, SysUtils, windows,helper_unicode,helper_diskio,helper_strings,
 ares_types,ares_objects,math,
// utility_ares,TntSysUtils,Dspack,tntwindows,
 DirectDraw, Directshow9, comobj,graphics,forms;
