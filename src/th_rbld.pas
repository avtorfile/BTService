...
interface
uses
classes,windows,sysutils,const_ares{,tntwindows},
ares_types,umediar,{comettrees,}SecureHash,helper_unicode,
helper_arescol,activeX,directDraw,Directshow9,{dspack,}ComObj,graphics,
helper_diskio,helper_strings,helper_mimetypes;
...
uses
 {ufrmmain,}
 helper_share_misc,dhtkeywords,bittorrentUtils;
