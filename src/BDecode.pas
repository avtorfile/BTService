...
uses
  SysUtils, Classes, Contnrs, hashes, dialogs;
...
//  showmessage('bdecodeHash begin');
  ...
  if ((c<'0') or (c>'9')) and (c<>'e') then result:=nil//bdecodeHash:=nil
   else result:=r//bdecodeHash:=r;

//   showmessage('bdecodeHash end');
end;
