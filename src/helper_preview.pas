...
uses
classes,windows,{ufrmpreview,}helper_unicode,helper_urls,
...
uses
 {ufrmmain,}{helper_player,}helper_ICH;
...
// end;
 ...
 Tnt_createdirectoryW(pwidechar(data_path+'\Temp'),nil);
  dira:=inttostr(gettickcount);
 Tnt_createdirectoryW(pwidechar(data_path+'\Temp\'+dira),nil);
